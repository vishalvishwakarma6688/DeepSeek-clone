      ...
      <div className="flex h-screen">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-4 pb-8 bg-[#292a2d] text-white relative">
          <div className="md:hidden absolute px-4 top-6 flex items-center justify-between w-full">
            <Image onClick={() => (expand ? setExpand(false) : setExpand(true))} src={assets.menu_icon} className="rotate-180" alt="" />
            <Image src={assets.chat_icon} className="opacity-70" alt="" />
          </div>
          {
            messages.length === 0 ? (
              <>
              ...
              <div className="relative flex flex-col items-center justify-start w-full mt-20 max-h-screen overflow-y-auto" ref={containerRef}>
                ...
                {
                  isLoading && (
                    <div className="flex gap-4 max-w-3xl py-3 w-full">
